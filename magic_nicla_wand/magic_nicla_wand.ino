...
//     tflite::MicroInterpreter *micro_interpreter = interpreter;
...
//     // ei_learning_config block_config
//     // TfLiteTensor *output = interpreter->output(block_config->output_data_tensor);
